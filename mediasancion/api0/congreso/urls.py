...
urlpatterns_comisiones = patterns('',
    url(r'^$',
        handler,
        {'handler_options': {'restsource': ComisionRestsource(primary_fields_only=True), 'paginate_by': 50}},
        name='list'),
...
urlpatterns_legisladores = patterns('',
    url(r'^$',
        handler,
        {'handler_options': {'restsource': LegisladorRestsource(primary_fields_only=True), 'paginate_by': 50}},
        name='list'),
