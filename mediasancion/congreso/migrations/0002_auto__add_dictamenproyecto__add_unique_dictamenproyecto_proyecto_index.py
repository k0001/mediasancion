...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DictamenProyecto'
        db.create_table('congreso_dictamenproyecto', (
            ...
            ('orden_del_dia', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
        ...
        db.send_create_signal('congreso', ['DictamenProyecto'])

        # Adding unique constraint on 'DictamenProyecto', fields ['proyecto', 'index']
        db.create_unique('congreso_dictamenproyecto', ['proyecto_id', 'index'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DictamenProyecto', fields ['proyecto', 'index']
        db.delete_unique('congreso_dictamenproyecto', ['proyecto_id', 'index'])

        # Deleting model 'DictamenProyecto'
        db.delete_table('congreso_dictamenproyecto')
